...
in quanto impatta negativamente sulla qualità di vita del paziente stesso. La gestione del dolore, 
è una delle dimensioni di cura più importanti. Il ruolo degli infermieri nella gestione del dolore è fondamentale, 
...
influenzata da fattori ambientali. Il dolore può essere di tipo acuto, cronico, refrattario, e i pazienti possono 
...
i pazienti continuano a soffrire, perché le pratiche non vengono attuate quotidianamente.
\cite{PAINONS}.\\
...
è di applicare le EBP (evidence based practice) alla pratica clinica; la ONS riconosce tuttavia che la ricerca 
può risultare difficoltosa, motivo per cui si impegna a fornire agli infermieri 
evidence-based abstract e raccomandazioni per la pratica clinica\cite{PAINONS}.\\
