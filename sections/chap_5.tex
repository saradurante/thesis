...
Il processo di costituzione delle CAR-T, attraversa una serie di fasi.\\
...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=0.5\columnwidth]{img/car-tprocess.jpeg}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=0.6\columnwidth]{img/CART-TherapyProcess.jpeg}
    \end{center}
...
influiscono anche sul suo grado di severità; ad esempio l'infusione di una dose elevata di CAR-T, le caratteristiche 
...
sierici di IL-6 (interleuchina-6); di conseguenza, il trattamento di prima scelta della CRS moderata-severa, 
...
ha prodotto delle linee guida\cite{ASBMT}.
...
ICANS può presentarsi in concomitanza della CRS, in tal caso ha una minore durata e severità; può insorgere anche 
in seguito alla CRS con maggiore durata e severità. La durata dei sintomi è variabile (circa 2-4 giorni
o anche diverse settimane) e sono solitamente reversibili. 
...
gli esami ematici evidenzieranno livelli elevati di LDH, ferritina e citochine, mentre si
...
che sono il target del CD-19 delle CAR-T; 
...
questo che si verifica questa complicanza.\\ 
...
possono non avere esperienza.\\ Le strutture ospedaliere che eseguono queste procedure di trattamento, 
devono assicurare aggiornamento e formazione infermieristica, per la gestione di questa 
