...
immunosoppressori usati nel post-trapianto o nell'infezione da HIV.\\
...
che di conseguenza sarà nei paesi industrializzati, negli uomini e nella razza bianca\cite{AIOM}.\\
...
ed elevati livelli dell’enzima lattato-deidrogenasi (LDH)\cite{AIOM}; elevati livelli ematici di tale enzima,
indicano la presenza di danno tissutale e cellulare. Valori normali sono compresi tra 80 e 300 mU/ml.\\ 
...
la scomparsa della malattia in ogni sede e anche i sintomi ad essa correlati (rientrano nella categoria RC pazienti 
