...
\begin{figure}[h]
    ...
    \end{center}
    \caption{Aspetto del linfoma non-hodgkin al microscopio
    \cite{img3}}
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Registro tumori AIRTUM. Tasso di incidenza anni 2010-2015.
    \cite{img6}}
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Registro tumori AIRTUM. Tasso di mortalità anni 2010-2015.
    \cite{img7}}
