...
\begin{figure}[H]
    \begin{center}
    \fbox{\includegraphics[width=0.5\columnwidth]{img/2021.png}}
    \vspace{-3mm}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
    \fbox{\includegraphics[width=0.5\columnwidth]{img/2020.png}}
    \vspace{-3mm}
    \end{center}
...
\end{subfigure}
    \caption{Stime dei dati epidemiologici per il linfoma non-Hodgkin negli Stati Uniti. \cite{{Americanstatistic}}}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
    \fbox{\includegraphics[width=0.7\columnwidth]{img/nhlstages.png}}
    \vspace{-3mm}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
    \fbox{\includegraphics[width=0.5\columnwidth]{img/MIPI.png}}
    \vspace{-3mm}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=0.7\columnwidth]{img/DEAUVILLE.png}
    \vspace{-3mm}
    \end{center}
...
su osso, questa procedura può non essere eseguita\cite{AIOM}.\\
