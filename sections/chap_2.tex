...
Nei pazienti con malattia avida, la risposta alla PET viene valutata mediante i criteri di Deauville (Figura \ref{fig:FIGURE_2.19})\cite{AIOM}. 
La risposta al trattamento può essere di remissione completa (RC) con punteggio 
