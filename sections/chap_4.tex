...
\begin{figure}[H]
    \begin{center}
    \fbox{\includegraphics[width=0.5\columnwidth]{img/Lumbar-Puncture.jpeg}}
    \vspace{-3mm}
    \end{center}
...
(peripherally inserted central catheter)(Figura \ref{fig:FIGURE_4.3}), CICC (central inserted central catheter), 
...
\begin{figure}[H]
    \begin{center}
    \fbox{\includegraphics[width=0.5\columnwidth]{img/picc-midline.jpg}}
    \vspace{-3mm}
    \end{center}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
            \fbox{\includegraphics[width=\linewidth]{img/CVC2.0.PNG}}
            \vspace{-3mm}
            \caption{Catetere venoso centrale\cite{{img41}}.}
            \label{fig:FIGURE_4.4}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \fbox{\includegraphics[width=\linewidth]{img/PORT.jpg}}
        \vspace{-3mm}
...
\begin{figure}[H]
    \begin{center}
    \fbox{\includegraphics[width=0.3\columnwidth]{img/picc-port.jpg}}
    \vspace{-3mm}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
    \fbox{\includegraphics[width=0.3\columnwidth]{img/portconfronto.jpeg}}
    \vspace{-3mm}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=0.9\columnwidth]{img/Types-of-adhesive-related-skin-injury.jpg}
    \vspace{-3mm}
    \end{center}
