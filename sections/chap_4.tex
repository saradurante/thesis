...
La chemioterapia è un trattamento che prevede l’utilizzo di farmaci, somministrati attraverso diverse vie, che tramite il 
...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=0.4\columnwidth]{img/CVC.png}
    \vspace{-3mm}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=0.5\columnwidth]{img/PORT.jpeg}
    \vspace{-3mm}
    \end{center}
    \caption{Il PORT
    \cite{img42}}
