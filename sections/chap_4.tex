...
L'accesso venoso centrale o catetere venoso centrale (CVC)(Figura \ref{fig:FIGURE_4.4}) è così definito quando la punta 
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
            \includegraphics[width=\linewidth]{img/CVC.png}
            \vspace{-3mm}
            \caption{}
            \label{fig:FIGURE_4.4}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\linewidth]{img/PORT.jpeg}
        \vspace{-3mm}
        \caption{}
        \label{fig:FIGURE_4.4B}
\end{subfigure}
\end{center} 
    \caption{Il catetere venoso centrale o CVC (a) e il PORT (b)\cite{{img41}}\cite{{img42}}}
...
\end{subfigure}
\end{center} 
    \caption{Espansione di uno stravaso (a)\cite{{STRAVASONURSE}}. Esempio di stravaso iatrogeno (b)\cite{{Iatrogeno}}}
...
\end{subfigure}
\end{center} 
    \caption{Stravaso da farmaco chemioterapico vescicante\cite{{STRAVASONURSE}}}
