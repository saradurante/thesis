...
fattori associati al paziente, caratteristiche fisico-chimiche del farmaco.\\ %citazione
...
per valutare l'efficacia del trattamento e che non ci sia progressione del danno con ulcerazione.\\ %citazione
...
\begin{figure}[H]
    ...
    \end{center}
    \caption[Tipi di MARSI]{Tipi di MARSI
    \cite{img58}}
...
obiettivi prefissati, la valutazione dei risultati ottenuti.\\ %CITAZIONE
