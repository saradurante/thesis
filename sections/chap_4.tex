...
ematici, per monitorare la comparsa di effetti collaterali come neutropenia, trombocitopenia, 
...
sono stati sviluppati diversi farmaci per cercare di controllare alcuni sintomi, come nausea e vomito; molti 
...
migliore per il paziente, evitare la presenza nell’ambiente di odori sgradevoli, cercare distrazioni, con 
immagini e musicoterapia per diminuire l’ansia, promuovere l’igiene orale frequente, somministrare antiemetici, 
sedativi e corticosteroidi prima e dopo il trattamento se necessario, 
...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=0.6\columnwidth]{img/LAVAGGIO-MANI.png}
    \vspace{-3mm}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=0.6\columnwidth]{img/FRIZIONAMENTO-MANI.jpeg}
    \vspace{-3mm}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=0.6\columnwidth]{img/5MOMENTI.png}
    \vspace{-3mm}
    \end{center}
...
ci sono alcuni chemioterapici per cui non si può prevedere se renderanno il paziente infertile, 
...
secrezioni ed edemi, motivo per cui la medicazione deve essere trasparente\cite{AIOMCVC}.\\
Per la disinfezione, si utilizza la clorexidina al 2\% in soluzione alcolica, oppure iodopovidone al 7\% o al 10\% 
in caso di indicazioni di allergia del paziente. È di fondamentale importanza rispettare i tempi di
...
all’uso di dispositivi di dimensioni sempre più piccole, fatti con materiale maggiormente compatibile, ha fatto si che 
le complicanze, nell’immediato post-operatorio, come pneumotorace, puntura dell’arteria ed
...
importanza l'ispezione dell’exit-site, per valutare il grado di alterazione della cute.\\ 
...
Il paziente ematologico, può sttraversare una fase di neutropenia, immunodepressione non neutropenica oppure può essere 
