...
(il calibro del catetere deve essere ⅓ del diametro della vena). In caso di braccio con diametro inferiore a 
35 cm si opta per un micro-port, in caso di diametro del braccio superiore a 35 cm si sceglie un mini-sitimplant\cite{GAVECELTPICCPORT}.\\
