...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=0.6\columnwidth]{img/bortreaction.png}
    \end{center}
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Come nascono e si differenziano i vari tipi cellulari da una cellula staminale emopoietica.
    \cite{img35}}
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Processo di prelievo e successiva trasfusione di cellule staminali emopoietiche nel trapianto autologo.
    \cite{img36}}
