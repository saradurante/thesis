...
le reazioni locali correlate alla somministrazione sottocutanea di chemioterapici, come mostrato nelle immagini sottostanti.
...
\begin{figure}[H]
    \begin{center}
    \fbox{\includegraphics[width=0.5\columnwidth]{img/PLICA.png}}
    \vspace{-3mm}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
    \fbox{\includegraphics[width=0.5\columnwidth]{img/SIRINGA.png}}
    \vspace{-3mm}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
    \fbox{\includegraphics[width=0.5\columnwidth]{img/transplant.jpeg}}
    \vspace{-3mm}
    \end{center}
