...
non usare borotalco, quando ci si lava usare acqua e sapone senza strofinare vigorosamente, 
...
fare attenzione all’esposizione al sole fino ad un anno dopo la fine della radioterapia, usare sempre la crema 
...
trattamento e che possono permanere anche per qualche settimana dalla fine del trattamento; 
...
ad altri trattamenti, come il trapianto di cellule staminali.\\ 
...
il trattamento, vengono eseguiti degli esami ematici specifici, 
...
La via sottocutanea risulta più vantaggiosa in quanto ha un assorbimento più rapido rispetto 
...
Le zone in cui si evidenziano rossore, calore, 
tumefazione, noduli, cute non integra, escoriazioni e segni di infiammazione, non devono essere usate per l'iniezione. 
...
per garantire la somministrazione dell’intera dose. L’iniezione deve essere lenta, facendo delle pause, 
...
banca dati). Il trapianto reduced-intensity è un’opzione che prevede dosi più basse di chemioterapia o 
radioterapia\cite{LLS}.\\
...
un’operazione chirurgica e talvolta possono verificarsi reazioni all’anestesia, danno ai 
...
da mantenere anche dopo la dimissione, fin quando il sistema immunitario non sarà più indebolito\cite{LLSBLOOD}.\\
